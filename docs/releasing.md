...
4. Tag that commit and push the tag, for example `git tag -a v0.1.4 -m "Release 0.1.4"` then `git push origin v0.1.4`.
5. Confirm the PyPI and GitHub release jobs both succeeded and test `pip install jades-eval==0.1.4` in a separate environment.
